            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <h2>Lista ubezpieczeń</h2>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>Rodzaj Ubezpieczenia</th>
                                        <th>Kwota Pokrycia</th>
                                        <th>Skladka</th>
                                        <th>Akcje</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    while ($row = oci_fetch_assoc($stmt)) {
                                        echo '<tr>';
                                        echo '<td>' . $row['rodzaj_ubezpieczenia'] . '</td>';
                                        echo '<td>' . $row['kwota_pokrycia'] . '</td>';
                                        echo '<td>' . $row['skladka'] . '</td>';
                                        echo '<td>';
                                        echo '<a href="edytuj_ubezpieczenie.php?id=' . $row['id'] . '" class="btn btn-warning btn-sm">Edytuj</a>';
                                        echo '<form action="php/ubezpieczenie/usun_ubezpieczenie.php" method="post" style="display:inline;">';
