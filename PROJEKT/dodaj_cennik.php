            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="row justify-content-center">
                        <h1 class="mt-5">Dodaj Cennik</h1>
                        <form class="mt-3" method="post" action="dodaj_cennik.php">
                            <div class="form-group">
                                <label for="kwota_za_dzien">Kwota za Dzień:</label>
                                <input type="number" class="form-control" id="kwota_za_dzien" name="kwota_za_dzien" step="any" required>
                            </div>

                            <div class="form-group">
                                <label for="kaucja">Kaucja:</label>
                                <input type="number" class="form-control" id="kaucja" name="kaucja" step="any" required>
                            </div>

                            <div class="form-group">
                                <label for="kara">Kara:</label>
                                <input type="number" class="form-control" id="kara" name="kara" step="any" required>
                            </div>
